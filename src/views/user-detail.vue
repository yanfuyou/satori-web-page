        ...
        <div class="overlay">
          <div class="tabs">
            <div class="tabs-labels">
              <span class="tabs-label">Commands</span><span class="tabs-label">Info</span
...
import { S } from "@/assets/js/fireworks.js";
      ...
      if (sparks[i].trail.length) {
        ...
        for (j = sparks[i].trail.length - 1; j >= 0; --j) {
          ...
          if (point2.d != -1) {
            ...
            ctx.lineWidth =
              1 + (sparks[i].radius * 10) / (sparks[i].trail.length - j) / (1 + point2.d);
